...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Instructions-to-Challenge-1-below:-Add-the-command-that-will-call-the-procedure.">Instructions to <mark>Challenge 1</mark> below: Add the command that will <strong>call</strong> the procedure.<a class="anchor-link" href="#Instructions-to-Challenge-1-below:-Add-the-command-that-will-call-the-procedure."> </a></h2>
</div>
</div>
</div>
    {% raw %}
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Instructions-to-Challenge-2-below:-Complete-the-follwing-timeConversion-procedure-in-JavaScript-(This-is-a-bonus-0.1-if-completed!)">Instructions to <mark>Challenge 2</mark> below: Complete the follwing timeConversion procedure in JavaScript (This is a bonus 0.1 if completed!)<a class="anchor-link" href="#Instructions-to-Challenge-2-below:-Complete-the-follwing-timeConversion-procedure-in-JavaScript-(This-is-a-bonus-0.1-if-completed!)"> </a></h2>
</div>
</div>
</div>
    {% raw %}
